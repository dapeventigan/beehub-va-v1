        ...
        <div className="navbar__link">
          ...
          <div className={!isOpen ? "navul__container" : "show"}>
            <ul className="navbar__links">
              ...
              <li>
                <div class="dropdown">
                  <a class="dropbtn">ABOUT US <FaAngleDown />
                  </a>
                  <div class="dropdown-content-small">
                    <a href="#contact">Why work with BeeHub</a>
                    <a href="#">Our Team</a>
                  </div>
                </div>
              </li>
              <li>
                <div class="dropdown">
                  <a class="dropbtn">OUR SERVICES <FaAngleDown />
                  </a>
              ...
              <li>
                <div class="dropdown">
                  <a class="dropbtn">OUR VAs <FaAngleDown />
                  </a>
                  <div class="dropdown-content">
                    <p className="dropdown-title">Virtual Assistants for Realtors</p>
                    <a href="#">Transaction Coordinator</a>
                    <a href="#">Listing Coordinator</a>
                    <a href="#">General Real Estate VA/ISA</a>
                    <p className="dropdown-title">Specialized Virtual Assistants</p>
                    <a href="#">Tier 1 (Newbies)</a>
                    <a href="#">Tier 2 (Has relevant experience)</a>
                    <a href="#">Tier 3 (SMEs/Managers)</a>
                    <p className="dropdown-title">Virtual Call Center (Coming Soon)</p>
                  </div>
                </div>
              </li>
              <li>
