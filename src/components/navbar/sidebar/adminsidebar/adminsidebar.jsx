    ...
    <div>
      ...
      <div className={`sidebar ${isOpen ? "open" : ""}`}>
        ...
        <div className="sidebar__contents">
          ...
          <div className="sidebar__content">
            <a href="/va-boards">Virtual Assistants</a>
          </div>
          <div className="sidebar__content">
            <a href="/job-boards">Job Boards</a>
          </div>
          <div className="sidebar__content">
            <a href="/admindashboard/hire">Hire a Virtual Assistant</a>
          </div>
          <div className="sidebar__content">
            <a href="/admindashboard/training">Add Training for Virtual Assistant</a>
          </div>
          <div className="sidebar__content">
